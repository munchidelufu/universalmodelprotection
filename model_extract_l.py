...
def fit(
    ...
    #
    save_dir = f"./bci_model/model_extract_l/{args.teacher_name}_{args.student_name}/model_extract_{index}"
...
if __name__ == "__main__":
    ...
    # teacher dataset
    _, attack_dataset = bci_loader.load_split_dataset(model_name=args.teacher_name)
    # pair_kfold
    kfold = KFoldGroupbyTrial(
        n_splits=5,
        shuffle=True,
